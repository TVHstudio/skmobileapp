...
use Skadate\Mobile\Controller\ServerUpdates as ServerUpdatesController;
...
use Skadate\Mobile\Controller\ContactUs as ContactUsController;
...
use Skadate\Mobile\Controller\CompatibleUsers as CompatibleUsersController;
...
use Skadate\Mobile\Controller\Webhooks as WebhooksController;
...
class SKMOBILEAPP_CTRL_Api extends OW_ActionController
{
    ...
    public function index()
    {
        ...
        $app['security.firewalls'] = [
            ...
            'store_webhooks' => [
                'pattern' => new RequestMatcher('/webhooks/(app-store|google-play)/$', null, ['GET', 'POST']),
                'anonymous' => true
            ],
        ...
        $app->mount('/contact-us', new ContactUsController);
        ...
        $app->mount('/server-updates', new ServerUpdatesController);
        ...
        $app->mount('/compatible-users', new CompatibleUsersController);
        ...
        $app->mount('/webhooks', new WebhooksController);
