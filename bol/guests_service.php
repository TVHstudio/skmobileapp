...
class SKMOBILEAPP_BOL_GuestsService extends SKMOBILEAPP_BOL_Service
{
    ...
    /**
     * Mark a guest as read
     * 
     * @param integer $userId
     * @return void
     */
    function markGuestAsRead($id, $userId)
    {
        $guestDao = OCSGUESTS_BOL_GuestDao::getInstance();
    ...
    public function formatGuestData($userId, array $guests)
    {
        ...
        {
            $processedGuests[$matchAction->recipientId]['user']['matchAction'] = [
        ...
        {
            $processedGuests[$avatar->userId]['user']['avatar'] = $this->getAvatarData($avatar, false);
        }
