...
import '../style/compatible_user_nothing_found_widget_style.dart';

class CompatibleUserNothingFoundWidget extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return compatibleUserNothingFoundWidgetWrapperContainer(
      Column(
