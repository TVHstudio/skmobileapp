...
abstract class BaseQuestions extends Base
{
        ...
        foreach ( $questionList as $question )
        {
            ...
            switch ($question->presentation) {
                ...
                case BOL_QuestionService::QUESTION_PRESENTATION_DATE :
                    $custom = !empty($custom)
                        ? ['minDate' => (int) $custom['year_range']['from'], 'maxDate' => (int) $custom['year_range']['to']]
                        : [];
    ...
    protected function prepareQuestionList( array $questionNames, array $questionsData = [] )
    {
        ...
        foreach ($questionList as $question) {
            ...
            $asyncQuestionValidators  = $asyncValidators;
            ...
            switch ($question->name) {
                ...
                default :
                    $event = new OW_Event('skmobileapp.prepare_question_list', [
                        ...
                        'async_validators' => $asyncQuestionValidators,
                    ...
                    if ( $data->getData() )
                    {
                        ...
                        $asyncQuestionValidators  = $questionEventData['async_validators'];
            ...
            $questions[] = array(
                ...
                'async_validators' => $asyncQuestionValidators,
                'params' => $questionParams,
                'is_valid' => $questionValue !== null ? true : null
            );
        }
