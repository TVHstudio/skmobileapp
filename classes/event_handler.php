...
class SKMOBILEAPP_CLASS_EventHandler extends SKMOBILEAPP_CLASS_AbstractEventHandler
{
    ...
    public function init()
    {
        ...
        $eventManager->bind(SKMOBILEAPP_CLASS_AdmobPagesEventCollector::EVENT_NAME, array($this, 'onCollectAdmobPages'));
    }
    ...
    /**
     * On collect Admob pages event handler.
     *
     * @param SKMOBILEAPP_CLASS_AdmobPagesEventCollector $event
     * @return void
     */
    public function onCollectAdmobPages(SKMOBILEAPP_CLASS_AdmobPagesEventCollector $event)
    {
        $event->addMultiple(SKMOBILEAPP_BOL_Service::getInstance()->getPluginAdmobPages());
    }
}
